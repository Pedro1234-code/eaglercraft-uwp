...
namespace winrt::UWPWebView2::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES XamlMetaDataProvider_base : implements<D, UWPWebView2::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = UWPWebView2::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"UWPWebView2.XamlMetaDataProvider";
        }
    };
}
namespace winrt::UWPWebView2::factory_implementation
{
    ...
    {
        using instance_type = UWPWebView2::XamlMetaDataProvider;
