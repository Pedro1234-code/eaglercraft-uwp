...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"UWPWebView2.MainPage"))
    {
        return winrt_make_UWPWebView2_MainPage();
    }

    if (requal(name, L"UWPWebView2.XamlMetaDataProvider"))
    {
        return winrt_make_UWPWebView2_XamlMetaDataProvider();
    }
